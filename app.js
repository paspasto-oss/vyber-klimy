(function(){
  ...
  var PRODUCTS={
    '2.5':[
      {tag:'Odporúčame Spektra',kind:'tip',brand:'HYUNDAI',name:'Hyundai REVOLUTION 09 · 2,5 kW',price:659,img:'https://www.spektrashop.sk/user/shop/orig/1380_g1bbf28dmg05elodyelyhl86k0axoxufguilgzwtwk-3.png?6a5e22b5',url:'/klimatizacia-hyundai-split-nastenna-revolution-09-r32-230v-2-5kw-2/',features:['Wi‑Fi zabudované','Ionizátor','Chladenie 2,6 kW']},
      {tag:'Komfortná voľba',kind:'comfort',brand:'SAMSUNG',name:'Samsung AR35 WIFI · 2,5 kW',price:746.30,img:'https://www.spektrashop.sk/user/shop/orig/1587_0jj5fq2nfxbdlfdgkfnrcxbcdvaubkxwzwxs7prdasw.png?6a5e22b7',url:'/klimatizacia-samsung-split-nastenna-ar35-wifi-ar40h09-r32-230v-2-5kw/',features:['Wi‑Fi zabudované','R32','Chladenie 2,6 kW']},
      {tag:'Prémiová voľba',kind:'premium',brand:'MITSUBISHI ELECTRIC',name:'Mitsubishi MSZ‑HR · 2,5 kW',price:949,img:'https://www.spektrashop.sk/user/shop/orig/2937_mitsubishi-nastenna-kompaktna-klimatizacia-msz-hr--2.jpg?6a6adf6f',url:'/mitsubishi-electric-msz-hr-2-5-kw/',features:['Kompaktné prevedenie','Energetická trieda A++','R32']}
    ],
    '3.5':[
      {tag:'Odporúčame Spektra',kind:'tip',brand:'HYUNDAI',name:'Hyundai REVOLUTION 12 · 3,5 kW',price:679,img:'https://www.spektrashop.sk/user/shop/orig/1386_g1bbf28dmg05elodyelyhl86k0axoxufguilgzwtwk-2.png?6a5e22b5',url:'/klimatizacia-hyundai-split-nastenna-revolution-12-r32-230v-3-5kw-2/',features:['Wi‑Fi zabudované','Ionizátor','Chladenie 3,5 kW']},
      {tag:'Komfortná voľba',kind:'comfort',brand:'SAMSUNG',name:'Samsung AR35 WIFI · 3,5 kW',price:827.48,img:'https://www.spektrashop.sk/user/shop/orig/1614_0jj5fq2nfxbdlfdgkfnrcxbcdvaubkxwzwxs7prdasw.png?6a5e22b7',url:'/klimatizacia-samsung-split-nastenna-ar35-wifi-ar40h12-r32-230v-3-5kw/',features:['Wi‑Fi zabudované','R32','Chladenie 3,5 kW']},
      {tag:'Prémiová voľba',kind:'premium',brand:'MITSUBISHI ELECTRIC',name:'Mitsubishi MSZ‑HR · 3,5 kW',price:1099,img:'https://www.spektrashop.sk/user/shop/orig/2934_mitsubishi-nastenna-kompaktna-klimatizacia-msz-hr--2.jpg?6a6adf6f',url:'/mitsubishi-electric-msz-hr-3-5-kw/',features:['Kompaktné prevedenie','Energetická trieda A++','R32']}
    ],
    '5.0':[
      {tag:'Odporúčame Spektra',kind:'tip',brand:'HYUNDAI',name:'Hyundai REVOLUTION 18 · 5,0 kW',price:1069,img:'https://www.spektrashop.sk/user/shop/orig/1413_g1bbf28dmg05elodyelyhl86k0axoxufguilgzwtwk-4.png?6a5e22b5',url:'/klimatizacia-hyundai-split-nastenna-revolution-18-r32-230v-5kw-2/',features:['Wi‑Fi zabudované','Chladenie 5,3 kW','Vykurovanie 5,6 kW']},
      {tag:'Komfortná voľba',kind:'comfort',brand:'SAMSUNG',name:'Samsung AR35 WIFI · 5,0 kW',price:1455.70,img:'https://www.spektrashop.sk/user/shop/orig/1716_0jj5fq2nfxbdlfdgkfnrcxbcdvaubkxwzwxs7prdasw.png?6a5e22b8',url:'/klimatizacia-samsung-split-nastenna-ar35-wifi-ar40h18-r32-230v-5kw/',features:['Wi‑Fi zabudované','Chladenie 5,3 kW','R32']},
      {tag:'Prémiová voľba',kind:'premium',brand:'MITSUBISHI ELECTRIC',name:'Mitsubishi MSZ‑HR · 5,0 kW',price:1399,img:'https://www.spektrashop.sk/user/shop/orig/2931_mitsubishi-nastenna-kompaktna-klimatizacia-msz-hr--2.jpg?6a6adf6f',url:'/mitsubishi-electric-msz-hr-5-0-kw/',features:['Kompaktné prevedenie','Energetická trieda A++','R32']}
    ],
    '7.0':[
      {tag:'Odporúčame Spektra',kind:'tip',brand:'HYUNDAI',name:'Hyundai REVOLUTION 24 · 7,0 kW',price:1459,img:'https://www.spektrashop.sk/user/shop/orig/1440_g1bbf28dmg05elodyelyhl86k0axoxufguilgzwtwk.png?6a5e22b5',url:'/klimatizacia-hyundai-split-nastenna-revolution-24-r32-230v-7kw/',features:['Wi‑Fi zabudované','Chladenie 7,0 kW','Vykurovanie 7,3 kW']},
      {tag:'Dizajnová voľba',kind:'comfort',brand:'HYUNDAI',name:'Hyundai CARBON GREY 24 · 7,0 kW',price:1729,img:'https://www.spektrashop.sk/user/shop/orig/1464_9tffxq-xfh15m89ypecga3qyroy20di4-mmtnaeco14-2.jpg?6a5e22b6',url:'/klimatizacia-hyundai-split-nastenna-carbon-grey-24-r32-230v-7kw/',features:['Sivý dizajn','Wi‑Fi zabudované','Chladenie 7,0 kW']},
      {tag:'Komfortná voľba',kind:'premium',brand:'SAMSUNG',name:'Samsung AR35 WIFI · 7,0 kW',price:1752.75,img:'https://www.spektrashop.sk/user/shop/orig/1773_0jj5fq2nfxbdlfdgkfnrcxbcdvaubkxwzwxs7prdasw-1.png?6a5e22b9',url:'/klimatizacia-samsung-split-nastenna-ar35-wifi-ar40h24-r32-230v-7kw/',features:['Wi‑Fi zabudované','Chladenie 7,0 kW','R32']}
    ]
  };
  ...
  .spk-calc{height:47px;border:0;border-radius:9px;background:${RED};color:#fff;font-size:14px;font-weight:800;cursor:pointer}
  .spk-note{margin-top:12px;color:#777;font-size:11px;line-height:1.4}
  ...
  .spk-products{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;align-items:stretch;overflow:visible!important;height:auto!important;max-height:none!important}
  .spk-card{position:relative;display:flex;flex-direction:column;min-width:0;background:#fff;color:${DARK};border-radius:15px;overflow:hidden;border:1px solid rgba(0,0,0,.07);box-shadow:0 8px 22px rgba(0,0,0,.12)}.spk-card.tip{outline:2px solid #f0b400}
  ...
  .spk-image{height:150px;padding:22px 14px 10px;display:flex;align-items:center;justify-content:center;background:#fff;border-bottom:1px solid #edf0f1}.spk-image img{max-width:100%;max-height:116px;object-fit:contain;display:block}
  ...
  .spk-btn{display:flex;align-items:center;justify-content:center;height:42px;margin-top:10px;border-radius:8px;background:#e00000;color:#fff!important;text-decoration:none!important;font-size:12px;font-weight:800}.spk-mount{display:block;margin:7px auto 0;border:0;background:transparent;color:${RED};font-size:11px;font-weight:700;text-decoration:underline;cursor:pointer}
  .spk-foot{display:flex;justify-content:space-between;gap:14px;margin-top:11px;color:rgba(255,255,255,.88);font-size:10px;line-height:1.35}.spk-foot a{color:#fff!important;font-weight:800;text-decoration:underline}
